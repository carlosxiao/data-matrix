define(['routes','angular-ui-router' , 'ne-app','services'], function (config) {
    'use strict';

    var app = angular.module('app', ['ui.router' , 'ngResource' , 'ngCookies' , 'w5c.validator' , 'App.services']);
    ...
    app.config(
        [
            ...
            function($locationProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $stateProvider, $resourceProvider , $urlRouterProvider , $httpProvider , w5cValidatorProvider)
            {
